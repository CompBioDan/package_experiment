...
#
# ## FLOWS
# births_flows_config <- DataModelConfig(
#   data_name = "births",
#   series_name = "births",
#   data_filenames = c(
#     "births_la_annual_cohorts.csv"
#   ),
#   uncertainty_filenames = c(""),
#   data_type = "flow",
...
# )
#
# births_flows_config <- populate_datamod_counts(births_flows_config, input_data_dir)
#
#
#
#
# birth_rates_config <- SystemModelConfig(
#   data_name = "births",
#   series_name = "births",
#   data_filenames = c(
...
# )
#
# births_config <- populate_sysmod_rates(births_config, input_data_dir)
# deaths_config <- populate_sysmod_rates(deaths_config, input_data_dir)
# ins_config <- populate_sysmod_rates(ins_config, input_data_dir)
# outs_config <- populate_sysmod_rates(outs_config, input_data_dir)
#
#
